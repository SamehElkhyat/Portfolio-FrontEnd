  ...
  const projects = [
    {
      ...
      category: "Frontend",
      description: "A modern web application for managing and tracking various business operations with a clean and intuitive user interface.",
    ...
    },
    {
      ...
      title: "Weather.io",
      category: "Frontend",
      description: "A weather application that provides real-time weather updates and forecasts with a beautiful and responsive design.",
    ...
    },
    {
      ...
      title: "Movie Flex",
      category: "Frontend",
      description: "A movie streaming platform with a modern UI and real-time movie search functionality.",
    ...
    },
    {
      ...
      title: "Yummy-Recipe",
      category: "Frontend",
      description: "A food recipe application with a beautiful UI and real-time recipe search functionality.",
    ...
    },
    {
      ...
      title: "Quran",
      category: "Frontend",
      description: "A digital Quran application with beautiful UI and real-time search functionality.",
    ...
    },
    {
      ...
      title: "Portfolio",
      category: "Frontend",
      description: "A modern and responsive portfolio website showcasing my skills and projects.",
